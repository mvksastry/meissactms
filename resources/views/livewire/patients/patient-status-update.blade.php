                      ...
                      <tbody>
                        ...
                        @hasrole('senior_resident')
                          <tr>
                            <td>
                              ...
                              <input wire:model="updated_status" disabled placeholder="Confirmed">
                            </td>
                          </tr>
                          <tr>
                            <td>
                        ...
                        @hasrole('clinical_manager')
                          <tr>
                            <td>
                              <label>New status</label>
                              <input wire:model="updated_status" disabled placeholder="Verified">
                            </td>
                          </tr>
                          <tr>
                            <td>
                        ...
                        @hasrole('director')
                          ...
                          <td>
                            <button wire:click="setNewPatientStatus('{{ $patient_uuid }}')" @class(['btn', 'btn-block', 'btn-info', 'rounded'])
                              type="button"><i @class(['ion', 'ion-person'])></i>&nbsp SET STATUS TO SEALED</button>
                          </td>
                        @endhasanyrole
