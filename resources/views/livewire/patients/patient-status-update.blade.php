                                            ...
                                            <tbody>
                                                ...
                                                @hasanyrole(['junior_resident', 'clinical_dataentry'])
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <label>Comment</label>
                                                            <input wire:model="status_comment" id="status_comment"
                                                                type="text" @class(['form-control'])
                                                                placeholder="Status Update Comment">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                ...
                                                @hasrole('clinical_manager')
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <button wire:click="setNewPatientStatus('{{ $patient_uuid }}')"
                                                                @class(['btn', 'btn-block', 'btn-info', 'rounded']) type="button"><i
                                                                    @class(['ion', 'ion-person'])></i>&nbsp Approve
                                                                Patient</button>
                                                        </td>
                                                    </tr>
                                                @endhasanyrole
                                                ...
                                                @hasrole('ctms_incharge')
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <button wire:click="setNewPatientStatus('{{ $patient_uuid }}')"
                                                                @class(['btn', 'btn-block', 'btn-info', 'rounded']) type="button"><i
                                                                    @class(['ion', 'ion-person'])></i>&nbsp Seal
                                                                Patient</button>
                                                        </td>
                                                    </tr>
                                                @endhasanyrole
                                                ...
                                                @hasrole('director')
                                                    <td>
                                                        <button wire:click="setNewPatientStatus('{{ $patient_uuid }}')"
                                                            @class(['btn', 'btn-block', 'btn-info', 'rounded']) type="button"><i
                                                                @class(['ion', 'ion-person'])></i>&nbsp Post Notes</button>
                                                    </td>
                                                @endhasanyrole
