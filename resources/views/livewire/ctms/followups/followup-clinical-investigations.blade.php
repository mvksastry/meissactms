                    ...
                    <div class="col-12">
                      ...
                      <div class="card">
                        <div class="card-header d-flex p-0">
                          <h3 class="card-title p-3">Clinical Information</h3>
                          <ul class="nav nav-pills ml-auto p-2">
                            <li class="nav-item"><a class="nav-link active" href="#tab_1"
                                data-toggle="tab">Controls</a></li>
                          ...
                          <div class="tab-content">
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      ...
                                      <input wire:model.defer="form.in_patient_id" id="in_patient_id" type="text"
                                        class="form-control" placeholder="In Patient ID">
                                    </td>
                                    <td>
                                      <label>Admission Date*</label>
                                      <input wire:model.defer="form.admission_date" id="aadhar_id" type="date"
                            ...
                            @if ($entry == 'update')
                              <div class="tab-pane" id="tab_3">
                                <livewire:ctms.patients.clinicals.blood-routine-component :data_type="$data_type"
                                  :patient_uuid="$patient_uuid" />
                              </div>
                              <!-- /.tab-pane -->
                              <div class="tab-pane" id="tab_4">
                                <livewire:ctms.patients.clinicals.liver-functions :data_type="$data_type" :patient_uuid="$patient_uuid" />
                                <livewire:ctms.patients.clinicals.electrolyte-component :data_type="$data_type"
                                  :patient_uuid="$patient_uuid" />
                              </div>
                              <!-- /.tab-pane -->
                              <div class="tab-pane" id="tab_5">
                                <livewire:ctms.patients.clinicals.renal-function-component :data_type="$data_type"
                                  :patient_uuid="$patient_uuid" />
                                <livewire:ctms.patients.clinicals.blood-urea-component :data_type="$data_type"
                                  :patient_uuid="$patient_uuid" />
                                <livewire:ctms.patients.clinicals.creatinine-component :patient_uuid="$patient_uuid" />
                              </div>
                              <!-- /.tab-pane -->
                              <div class="tab-pane" id="tab_6">
                                <livewire:ctms.patients.clinicals.blood-sugar-component :data_type="$data_type"
                                  :patient_uuid="$patient_uuid" />
                              ...
                              <div class="tab-pane" id="tab_7">
                                <livewire:ctms.patients.clinicals.laboratory-exams :data_type="$data_type"
                                  :patient_uuid="$patient_uuid" />
                              </div>
                              <!-- /.tab-pane -->
                              <div class="tab-pane" id="tab_8">
                                <livewire:ctms.patients.clinicals.chemical-exam-component :data_type="$data_type"
                                  :patient_uuid="$patient_uuid" />
                              </div>
                              <!-- /.tab-pane -->
                              <div class="tab-pane" id="tab_9">
                                <livewire:ctms.patients.clinicals.microscopic-exams :data_type="$data_type"
                                  :patient_uuid="$patient_uuid" />
                              </div>
                              <!-- /.tab-pane -->
                              <div class="tab-pane" id="tab_10">
                                <livewire:ctms.patients.clinicals.urine-routine-component :data_type="$data_type"
                                  :patient_uuid="$patient_uuid" />
                              </div>
                              <!-- /.tab-pane -->
                              <div class="tab-pane" id="tab_11">
                                <livewire:ctms.patients.clinicals.general-summary-component :data_type="$data_type"
                                  :patient_uuid="$patient_uuid" />
                              </div>
                              <!-- /.tab-pane -->
