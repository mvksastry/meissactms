            ...
            <div class="card card-primary card-outline">
              <div class="card-header">
                <h3 class="card-title">
                  ...
                  Data Review: Sensory Exams Score
                </h3>
                      ...
                      <div class="card">
                        ...
                        <div class="card-header d-flex p-0">
                          <ul class="nav nav-pills ml-auto p-2">
                            ...
                            @endforeach
                            @else
                              <label class="text-danger">No Information Retrieved</label>
                            @endif
                          </ul>
                        </div><!-- /.card-header -->
                        <div class="card-body">
                              ...
                              <div class="tab-pane" id="tab_{{ $j }}">
                                <table id="userIndex2" class="table table-sm table-bordered table-hover">
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                      <td>
                                        <label>Right L1</label>
                                        </br>
                                        {{ $Obj->rL1 }}
                                      </td>
                                      <td>
                                        <label>Right L2</label>
                                        </br>
                                        {{ $Obj->rL2 }}
                                      </td>
                                      <td>
                                        <label>Right L3</label>
                                        </br>
                                        {{ $Obj->rL3 }}
                                      </td>
                                      <td>
                                        <label>Right L4</label>
                                        </br>
                                        {{ $Obj->rL4 }}
                                      </td>
                                      <td>
                                        <label>Right S1</label>
                                        </br>
                                        {{ $Obj->rS1 }}
                                      </td>
                                    </tr>
