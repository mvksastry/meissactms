    ...
    <table id="userIndex2" class="table table-sm table-bordered table-hover">
      ...
      <tbody>
        <tr>
          ...
          <td>
            <label>Sample ID</label>
            <input wire:model.defer="form_g.linked_sample_id" type="text" class="form-control"
        ...
        <tr>
          <td colspan="3">
            <label>Other Infos</label>
            <input wire:model.defer="form_g.other_infos" type="text" class="form-control"
        ...
        <tr>
          <td colspan="3">
            <label>Comment</label>
            <input wire:model.defer="form_g.administrative_comment" id="other_infos_2" type="text"
