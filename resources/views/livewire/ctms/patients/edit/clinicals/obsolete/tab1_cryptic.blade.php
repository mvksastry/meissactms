  <table id="userIndex2" class="table table-sm table-bordered table-hover">
    ...
    <tbody> 
      <tr>
        <td colspan="1">
          <label>Opd ID</label>
          <input wire:model="form.opd_id" id="opd_id" type="text" class="form-control" placeholder="Opd ID*">
        </td>
        <td colspan="1">
    ...
    <tbody> 
      ...
      <tr>
        ...
        <td>
          ...
          <input wire:model.defer="form.procalcitonin" type="text" class="form-control" placeholder="Procalcitonin" >
        </td>
      </tr>                                   
    </tbody>
  </table>
