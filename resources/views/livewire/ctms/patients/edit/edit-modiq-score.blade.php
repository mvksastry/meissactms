                      ...
                      <div class="card-body">
                        <div class="tab-content">
                              ...
                              <div class="col-6">
                                <div class="card-body">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="form-check">
                                      <input wire:model.live="employment_home_making" class="form-check-input"
                                        type="radio" value="0" id="emp_home" name="emp_home">
                                      <label class="form-check-label">My normal homemaking/job activities do not cause
                                        pain.</label>
                                    </div>
                                    <div class="form-check">
                                      <input wire:model.live="employment_home_making" class="form-check-input"
                                        type="radio" value="1" id="emp_home" name="emp_home">
                                    ...
                                    <div class="form-check">
                                      <input wire:model.live="employment_home_making" class="form-check-input"
                                        type="radio" value="2" id="emp_home" name="emp_home">
                                  ...
                                  <table id="userIndex2" class="table table-sm table-bordered table-hover">
                                    ...
                                    <tbody>
                                      <tr>
                                        ...
                                        <td>
                                          <label
                                            class="form-check-label">{{ $modq_obj->pain_intensity != null ? $modq_painIntensity[$modq_obj->pain_intensity] : null }}</label>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td>
                                        ...
                                        <td>
                                          <label
                                            class="form-check-label">{{ $modq_obj->personal_care != null ? $modq_persCare[$modq_obj->personal_care] : null }}</label>
                                        </td>
                                      </tr>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <label
                                            class="form-check-label">{{ $modq_obj->lifting != null ? $modq_lifting[$modq_obj->lifting] : null }}</label>
                                        </td>
                                      </tr>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <label
                                            class="form-check-label">{{ $modq_obj->walking != null ? $modq_walking[$modq_obj->walking] : null }}</label>
                                        </td>
                                      </tr>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <label
                                            class="form-check-label">{{ $modq_obj->sitting != null ? $modq_sitting[$modq_obj->sitting] : null }}
                                          </label>
                                        </td>
                                      </tr>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <label
                                            class="form-check-label">{{ $modq_obj->standing != null ? $modq_standing[$modq_obj->standing] : null }}</label>
                                        </td>
                                      </tr>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <label
                                            class="form-check-label">{{ $modq_obj->sleeping != null ? $modq_sleeping[$modq_obj->sleeping] : null }}</label>
                                        </td>
                                      </tr>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <label
                                            class="form-check-label">{{ $modq_obj->social_life ? $modq_sociallife[$modq_obj->social_life] : null }}
                                          </label>
                                        </td>
                                      </tr>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <label
                                            class="form-check-label">{{ $modq_obj->travelling != null ? $modq_travelling[$modq_obj->travelling] : null }}</label>
                                        </td>
                                      </tr>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <label
                                            class="form-check-label">{{ $modq_obj->employment_home_making != null ? $modq_emphome[$modq_obj->employment_home_making] : null }}</label>
                                        </td>
                                      </tr>
                                    </tbody>
                                  </table>
                            ...
                            <table id="userIndex2" class="table table-sm table-bordered table-hover">
                              ...
                              <tbody>
                                <tr>
                                  <td colspan="1">
                                    <label>Opd ID</label>
                                    <input wire:model="form.opd_id" class="form-control"
                                      placeholder="Out Patient ID">
                                  </td>
                                  <td colspan="1">
                                    <label>In Patient ID</label>
                                    <input wire:model.defer="form.in_patient_id" type="text" class="form-control"
                                      placeholder="In Patient ID">
                                  </td>
                                  <td colspan="1">
                                    <label>Admission Date</label>
                                    <input wire:model.defer="form.admission_date" type="date" class="form-control"
                          ...
                          <div class="tab-pane" id="tab_4">
                            ...
                            <table id="userIndex2" class="table table-sm table-bordered table-hover">
                              ...
                              <tbody>
                                <tr>
                                  <td colspan="2">
                                    <label>Comment</label>
                                    <input wire:model="form.comment_entered_by" type="text" class="form-control"
                                      placeholder="Comment">
                                  </td>
                                </tr>
                                <tr>
                                  <td colspan="1">
                                    ...
                                    <input wire:model="form.entered_by" type="text" class="form-control"
                                      placeholder="Entered By">
                                  </td>
                                  <td colspan="1">
                                    <label>Entry Date</label>
                                    <input wire:model="form.entry_date" type="date" class="form-control"
                            ...
                            <button wire:click="fnEditModqScoreData()"
                              class="btn btn-warning font-normal mt-3 rounded">EDIT MODQ INFO</button>
                          </div>
                          <!-- /.tab-pane -->
                          <!-- /.tab-content -->
                        </div>
