                      ...
                      <div class="card-body">
                        <div class="tab-content">
                            ...
                            <table id="userIndex2" class="table table-sm table-bordered table-hover">
                              ...
                              <tbody>
                                <tr>
                                  <td>
                                    <label>Opd ID</label>
                                    <input wire:model="form.opd_id" type="text" class="form-control"
                          ...
                          <div class="tab-pane" id="tab_2">
                            ...
                            //dd($old_replies);
                            $rmqreplies = config('ctms.rmqreplies');
                            ?>
                            <div class="row">
                              <div class="col-6">
                                <table id="userIndex2" class="table table-sm table-bordered table-hover">
                            ...
                            <table id="userIndex2" class="table table-sm table-bordered table-hover">
                              ...
                              <tbody>
                                <tr>
                                  <td colspan="2">
                                    <label>Comment</label>
                                    <input wire:model.defer="form.comment_entered_by" type="text"
                                ...
                                <tr>
                                  ...
                                  <td>
                                    ...
                                    <input wire:model="form.entry_date" type="date" value="null"
                                      class="form-control" placeholder="Entry Date">
                                  </td>
                                </tr>
                              </tbody>
                            </table>

                            <button wire:click="fnEditRMQInfo()"
                              class="btn btn-success text-white font-normal mt-3 rounded">EDIT RMQ INFO</button>
                          </div>
                          <!-- /.tab-pane -->
                          <!-- /.tab-content -->
                        </div>
