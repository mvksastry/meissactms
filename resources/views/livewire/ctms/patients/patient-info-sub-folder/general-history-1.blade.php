<table id="userIndex2" class="table table-sm table-bordered table-hover">
    ...
    <tbody>        
      ...
      <tr>
        <td colspan="4">
          <label>HIV</label>
          <input wire:model.defer="form.hiv" id="hiv_status" type="text" value="null" class="form-control" placeholder="Description">
        </td>
      </tr>
      <tr>
        <td colspan="4">
          <label>AIDS</label>
          <input wire:model.defer="form.aids" id="aids_status" type="text" value="null" class="form-control" placeholder="Description">
        </td>
      </tr>
      <tr>
        <td colspan="4">
          <label>Hepatitis B</label>
          <input wire:model.defer="form.hepatitis_b" id="hepatitis_b" value="null" class="form-control" placeholder="Description">
        </td>
      </tr>
      <tr>
        <td colspan="4">
          <label>Hepatitis C</label>
          <input wire:model.defer="form.hepatitis_c" id="hepatitis_c" type="text" value="null" class="form-control" placeholder="Description">
        </td>
      </tr>
      <tr>
        <td colspan="4">
