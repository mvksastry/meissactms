            ...
            <div class="card card-primary card-outline">
              <div class="card-header">
                <h3 class="card-title">
                  ...
                  Sensory Examinations - Dermatome Grades
                </h3>
                        ...
                        <div class="card-body">
                          <div class="tab-content">
                            ...
                            <div class="tab-pane" id="tab_3">
                              ...
                              <button wire:click="fnSaveSensoryExaminationData()" class="btn btn-success text-white font-normal mt-3 rounded">ADD SENSORY INFO</button>
                            </div>
                            <!-- /.tab-pane -->
