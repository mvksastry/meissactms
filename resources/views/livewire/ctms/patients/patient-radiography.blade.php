                            ...
                            <tbody> 
                              <tr>
                                <td class="text-center">
                                  <button wire:click="fnUploadLSImages()" type="button" class="btn btn-block btn-primary"><i class="ion ion-person"></i>&nbsp Life Style Images</button>
                                </td>
                              </tr>
                              <tr>
                                <td class="text-center">
                                  <button wire:click="fnUploadLSVideo()" type="button" class="btn btn-block btn-primary"><i class="ion ion-person"></i>&nbsp Life Style Videos</button>
                                </td>
                              </tr>
                              <tr>
                                <td class="text-center">
