    ...
    <tbody>        
      <tr>
        <td colspan="2">
          ...
          <input wire:model.defer="form_n.miscoff1" type="file" class="form-control" placeholder="Report File" >
      ...
      <tr>
        ...
        <td colspan="2">
          ...
          <input wire:model.defer="form_o.miscoff2" type="file" class="form-control" placeholder="Report File" >
