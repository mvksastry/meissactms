      ...
      @foreach ($todo_list as $item)
        <li>
          ...
          <div class="icheck-primary d-inline ml-2">
            <input type="checkbox" value="" @if ($item->is_seen) checked="checked" @endif name="todo1"
              id="todoCheck1">
          ...
          <div class="tools">
            ...
            <i wire:click="deleteItem('{{ $item->uuid }}')" class="fas fa-trash"></i>
          </div>
        </li>
      @endforeach
    </ul>
  ...
  <div class="card-footer">
    <div class="input-group">
      ...
      <span class="input-group-append">
        <button type="button" wire:click="setTodoItem()" class="btn btn-primary float-right"><i
