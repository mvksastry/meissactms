        ...
        @else
          ...
          <div class="direct-chat-msg right">
            <div class="direct-chat-infos clearfix">
              ...
              <span
                class="direct-chat-timestamp float-left">{{ date('d M g:i a', strtotime($chat->created_at)) }}</span>
            </div>
            <!-- /.direct-chat-infos -->
            <img class="direct-chat-img" src="{{ asset('assets/dist/img/user4-128x128.jpg') }}"
            ...
            <a href="#">
              ...
              <div class="contacts-list-info">
                <span class="contacts-list-name">
                  {{ $contact->name }}
                  <small class="contacts-list-date float-right">Last Login:
                    {{ date('d-m-Y', strtotime($contact->last_login)) }}</small>
                </span>
