    ...
    <div class="content-wrapper px-2">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 mb-3">Inventory: Review Consumption</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="/manage-inventory">Home: Inventory</a></li>
                <li class="breadcrumb-item active">Review Consumption</li>
              </ol>
            </div><!-- /.col -->
              ...
              <div class="card card-primary card-outline">
                <div class="card-header">
                  <h3 class="card-title">
                    ...
                    Inventory Home: Search Criteria
                  </h3>
                            ...
                            <tbody>     
                                <tr>
                                  ...
                                  <td>
                                      ...
                                      <button type="button" class="btn btn-block btn-outline-primary">By User</button>
                                  </td>
                                  ...
                                  <td>                                    
                                    ...
                                    <button type="button" class="btn btn-block btn-outline-primary">By Project</button>
                                  </td>

                                  
                                  <td>
                                    <div class="form-group">
                                      <input type="text" class="form-control" wire:model="catalog_number" placeholder="Enter ...">
                                    </div>
                                    <button type="button" class="btn btn-block btn-outline-primary">By Catalog Number</button>
                                  </td>

                                  
                                  <td>
                                    <div class="form-group">
                                      <input type="date" class="form-control" wire:model="date_from" placeholder="Enter ...">
                                    </div>
                                    <button type="button" class="btn btn-block btn-outline-primary">By Dates</button>
                                  </td>

                                  <td>
                                    <div class="form-group">
                                      <input type="date" class="form-control" wire:model="date_to" placeholder="Enter ...">
                                    </div>
                                    <button type="button" class="btn btn-block btn-outline-primary">By Dates</button>
                                  </td>
                                </tr>
