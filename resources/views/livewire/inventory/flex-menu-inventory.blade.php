...
<div class="col-md-4 col-sm-6 col-12">
  <div class="info-box">
    ...
    <div class="info-box-content">
      <span class="info-box-text">UPDATE CONSUMPTION</span>
...
<div class="col-md-4 col-sm-6 col-12">
  <div class="info-box">
    ...
    <div class="info-box-content">
      <span class="info-box-text">REVIEW CONSUMPTION</span>
...
<div class="col-md-4 col-sm-6 col-12">
  <div class="info-box">
    ...
    <div class="info-box-content">
      <span class="info-box-text">REPLINISHMENT</span>
...
<div class="col-md-4 col-sm-6 col-12">
  <div class="info-box">
    <span class="info-box-icon bg-info">
      <a href="/bulk-import-inventory" wire:navigate>
      <i class="far fa-envelope"></i>
      </a>
    </span>
    <div class="info-box-content">
      <span class="info-box-text">BULK IMPORT</span>
      <span class="info-box-number">1,410</span>
    </div>
    <!-- /.info-box-content -->
  </div>
