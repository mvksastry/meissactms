      ...
      <div class="content-wrapper px-2">
        ...
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1 class="m-0 mb-3">Home: Re-make Reagent</h1>
              </div><!-- /.col -->
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item"><a href="/manage-reagents">Home: Reagents</a></li>
                  <li class="breadcrumb-item active">Re-make Reagent</li>
                </ol>
              </div><!-- /.col -->        
            </div><!-- /.row -->
          </div><!-- /.container-fluid -->
