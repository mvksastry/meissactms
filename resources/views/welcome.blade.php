...
<html class="no-js" lang="">
  ...
  <body>
    ...
    <section id="home" class="hero-section-wrapper-5">
      ...
      <!-- ========================= hero-5 start ========================= -->
      <div class="hero-section hero-style-5 img-bg" style="background-image: url('lassets/img/hero/hero-5/hero-bg.svg')">
        <div class="container">
          <div class="row">
            <div class="col-lg-6">
              <div class="hero-content-wrapper">
                <h2 class="mb-30 wow fadeInUp" data-wow-delay=".2s">CTMS by Meissa Software Solutions.</h2>
                  <p class="mb-30 wow fadeInUp" data-wow-delay=".4s">Please login to execute projects.</p>
                    @if (Route::has('login'))
                      @auth
                          <a href="{{ url('/dashboard') }}" class="button button-lg radius-50 wow fadeInUp" data-wow-delay=".6s">
                              Dashboard
                          </a>
                      @else
                          <a href="{{ route('login') }}" class="button button-lg radius-50 wow fadeInUp" data-wow-delay=".6s">Log in <i class="lni lni-chevron-right"></i> </a>
                      @endauth
                    @endif
              </div>
            </div>
            <div class="col-lg-6 align-self-end">
              <div class="hero-image wow fadeInUp" data-wow-delay=".5s">
                <img src="{{asset('lassets/img/hero/hero-5/hero-img.svg')}}" alt="">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row justify-content-center">
          <div class="col-xxl-5 col-xl-5 col-lg-7 col-md-8">
            <div class="section-title text-center mb-60">
              ...
              <p class="wow fadeInUp" data-wow-delay=".4s">Biotechnology companies doing research and development.</p>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6">
            <div class="single-feature wow fadeInUp" data-wow-delay=".2s">
              ...
              <div class="content">
                <h5>E - L a b</h5>
                <p>Automate your research laboratory end-to-end. Track every resorce, never regret</p>
              </div>
            </div>
          </div>
          <div class="col-lg-4 col-md-6">
            <div class="single-feature wow fadeInUp" data-wow-delay=".4s">
              ...
              <div class="content">
                <h5>M A R S</h5>
                <p>Management of Experimental Animal & Research Systems, Project - Facility Management</p>
              </div>
            </div>
          </div>
          <div class="col-lg-4 col-md-6">
            <div class="single-feature wow fadeInUp" data-wow-delay=".6s">
              ...
              <div class="content">
                <h5>C T M S</h5>
                <p>Comprehensive Clinical Trial Management systems - Multi center, multiple arms</p>
              </div>
            </div>
          </div>
          <div class="col-lg-4 col-md-6">
            <div class="single-feature wow fadeInUp" data-wow-delay=".2s">
              ...
              <div class="content">
                ...
                <p>Take up comprehensive content management</p>
              </div>
            </div>
          </div>
          <div class="col-lg-4 col-md-6">
            <div class="single-feature wow fadeInUp" data-wow-delay=".4s">
              ...
              <div class="content">
                <h5>Best Security</h5>
                <p>Worlds most reliable secure standard code with high order database managment</p>
              </div>
            </div>
          </div>
          <div class="col-lg-4 col-md-6">
            ...
            <div class="about-content-wrapper">
              ...
              <ul>
                <li class="wow fadeInUp" data-wow-delay=".35s">
                  ...
                  Give a change to see the results.
                </li>
              ...
              <div class="pricing-active">
                ...
                <div class="single-pricing-wrapper">
                  <div class="single-pricing">
                    ...
                    <h3> Ask </h3>
                    <ul>
                      <li>Experimental Animal Facility</li>
                      <li>IAEC Projects</li>
                      <li>All Animal Protocols</li>
                      <li>Awesome Support</li>
                    </ul>
                    <a href="#0" class="button radius-30">Get Started</a>
                  </div>
