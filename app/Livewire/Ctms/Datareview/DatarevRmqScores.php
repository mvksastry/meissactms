...
class DatarevRmqScores extends Component
{
    use Base;
    //Trait binding
    ...
    public function mount($patient_uuid)
    {
        ...
        $this->Objs = RMQReply::where('patient_uuid', $this->patient_uuid)->get();
        //dd($this->Objs);
    }

    public function render()
    {
        return view('livewire.ctms.datareview.datarev-rmq-scores');
    }
}
