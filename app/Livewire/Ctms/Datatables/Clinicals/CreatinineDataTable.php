...
class CreatinineDataTable extends DataTableComponent
{
    protected $model = Creatinine::class;
    ...
    {
        $this->setPrimaryKey('creatinine_id');
    }
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make("Serum Creatinine", "serum_creatinine")
                ->sortable(),
