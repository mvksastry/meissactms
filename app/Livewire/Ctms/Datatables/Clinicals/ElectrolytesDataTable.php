...
class ElectrolytesDataTable extends DataTableComponent
{
    protected $model = Electrolytes::class;
    ...
    {
        $this->setPrimaryKey('electrolyte_id');
    }
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make("Sodium", "sodium")
                ->sortable(),
            Column::make("Potassium", "potassium")
                ->sortable(),
            Column::make("Chloride", "chloride")
                ->sortable(),
