...
class PatientFollowupStatusUpdate extends Component
{
    use Base;
    use TPatientStatus;
    ...
    public function setPatientCurrentStatus($patient_uuid)
    {
        ...
        //his->pcs['clinicaldata'] = ClinicalData::where('patient_uuid', $patient_uuid)->first();
    ...
    {
        return view('livewire.patients.patient-followup-status-update');
    }
    ...
    public function setNewPatientStatus($patient_uuid)
    {
        ...
        switch ($role) {
            ...
            case 'senior_resident':
                $input['status_code'] = $this->status_code; //data capture began first time.
